...
def scale_frame(frame):
    df = frame.copy()
    X,y = df.drop(columns = ['CO2 Emissions(g/km)']), df['CO2 Emissions(g/km)']
...
if __name__ == "__main__":
    ...
    params = {'alpha': [0.00001, 0.0001, 0.001, 0.01, 0.05, 0.1, 1.0],
              'l1_ratio': [0.0, 0.01, 0.1, 0.3, 0.5, 0.7, 1.0]
              }
    
    mlflow.set_experiment("linear model cars CO2")
